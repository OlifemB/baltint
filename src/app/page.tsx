                    ...
                    <div className={'flex flex-col md:flex-row container mx-auto px-4 md:px-0 py-16 lg:px-0 gap-8'}>
                        <div className={'flex flex-col flex-1 items-start justify-center gap-8'}>
                            <div className={'flex flex-col justify-start items-start max-w-xl gap-6'}>
                                <h1 className={'text-5xl md:text-6xl font-extrabold tracking-wide color-primary'}>
                                    {pageData.sections[0].title.split(' ').map((item, index) =>
                                        <span className={'block'} key={`big-${index}`}>
                                            {item}
                                        </span>
                                    )}
                                </h1>
