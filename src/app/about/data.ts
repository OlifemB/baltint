...
export const data: IAboutPageData = {
    ru: {
        sections: [{
            title: 'О компании',
            text2: 'Подход к каждому клиенту индивидуальный, а принимаемые решения прозрачны. Компания работает с российскими предприятиями. Мы используем широкий спектр современных технологий, учимся на предыдущем опыте и ищем перспективы для будущего развития.',
            text:'Компания «БИГ» предоставляет услуги разработки, внедрения и сопровождения информационных, справочных, учетных систем. Кроме того, компания разрабатывает мобильные приложения для различных платформ и автоматизирует системы управления строительных и сервисных компаний.',
            img: {
                src: img,
                alt: 'headerImg'
            },
